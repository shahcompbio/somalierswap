...
**shahcompbio/somalierswap** is a bioinformatics pipeline that ...
...
<!-- If you use shahcompbio/somalierswap for your analysis, please cite it using the following doi: [10.5281/zenodo.XXXXXX](https://doi.org/10.5281/zenodo.XXXXXX) -->
